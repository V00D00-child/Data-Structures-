/*This is the Stack class the methods in this class will:
1. Push a new element onto a stack (This method should put data onto the stack, which means it must first put the data in a stack element.)
2. Pop an element off the stack and return the data in the element.
3. Print a list of the data in the stack.
4. Return the current stack size.
 * 
 */
